        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {productCategories.map((category) => (
            <button
              ...
              className="glass-card glass-card-hover group relative overflow-hidden text-left"
            >
              ...
              <div className="p-6">
                <h2 className="text-xl md:text-2xl font-serif font-semibold text-foreground transition-colors duration-300 group-hover:text-primary">
                  {category.name}
                </h2>
